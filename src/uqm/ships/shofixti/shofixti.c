...
self_destruct (ELEMENT *ElementPtr)
{
	...
	else
	{
				...
				hElement != 0; hElement = hNextElement)
		{
			...
			{
			COUNT DESTRUCT_RANGE;
			DESTRUCT_RANGE= ((180+(80*badguysImprove)) << RESOLUTION_FACTOR);
            //#define DESTRUCT_RANGE (180 << RESOLUTION_FACTOR) // JMS_GFX
                ...
                COUNT MAX_DESTRUCTION;
                MAX_DESTRUCTION = ((DESTRUCT_RANGE >> RESOLUTION_FACTOR) / 10); // JMS_GFX
					SIZE destruction;
