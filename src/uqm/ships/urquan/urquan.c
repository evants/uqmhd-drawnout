...
#define URQUAN_OFFSET (32 << RESOLUTION_FACTOR) // JMS_GFX
	...
	MissileBlock.damage = MISSILE_DAMAGE+badguysImprove;
	MissileBlock.life = MISSILE_LIFE + badguysImprove;
...
int FIGHTER_SPEED;// =8-(badguysImprove%2);
...
fighter_preprocess (ELEMENT *ElementPtr)
{
	...
	FIGHTER_SPEED=((8+(4*badguysImprove)) << RESOLUTION_FACTOR);
    FIGHTER_LIFE=(ONE_WAY_FLIGHT + ONE_WAY_FLIGHT + 150)+20*badguysImprove;
