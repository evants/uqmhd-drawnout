...
//#define NUM_DRIVE_SLOTS 11 //original
//#define NUM_DRIVE_SLOTS 13 //upgraded
#define MAX_NUM_DRIVE_SLOTS 11
//#define MAX_NUM_DRIVE_SLOTS 13
#define NUM_JET_SLOTS 8
//#define NUM_MODULE_SLOTS 16 //original
//#define NUM_MODULE_SLOTS 20 //upgraded
//#define MAX_NUM_MODULE_SLOTS 16
#define MAX_NUM_MODULE_SLOTS 20
...
//#define DRIVE_SIDE_X ((31 << RESOLUTION_FACTOR)) //b4 upgrade //JMS_GFX
//#define DRIVE_SIDE_X ((22 << RESOLUTION_FACTOR))  // after upgrade //JMS_GFX
#define DRIVE_SIDE_Y ((56 << RESOLUTION_FACTOR)) // JMS_GFX
//#define DRIVE_TOP_X ((33 << RESOLUTION_FACTOR) + RES_CASE(0,42,100)) // JMS_GFX //orig
//#define DRIVE_TOP_X ((22 << RESOLUTION_FACTOR) + RES_CASE(0,42,100)) // JMS_GFX //improved
...
//#define MODULE_SIDE_X ((17 << RESOLUTION_FACTOR) + RES_CASE(0,21,55) -100) // JMS_GFX
...
//#define MODULE_TOP_X ((17 << RESOLUTION_FACTOR) + RES_CASE(0,22,55) -100) // JMS_GFX
...
typedef struct
{
	...
	BYTE ModuleSlots[MAX_NUM_MODULE_SLOTS];
	//BYTE DriveSlots[NUM_DRIVE_SLOTS];
	BYTE DriveSlots[MAX_NUM_DRIVE_SLOTS];
...
extern COUNT MODULE_SIDE_X;// = ((17 << RESOLUTION_FACTOR) + RES_CASE(0,21,55) -100);
extern COUNT MODULE_TOP_X;// = ((17 << RESOLUTION_FACTOR) + RES_CASE(0,21,55) -100);
...
extern BOOLEAN thrusterUpgraded;
extern BOOLEAN modulesUpgraded;
extern bool blasterUpgraded;
extern bool energyUpgraded;
extern bool earthlingUpgraded;

extern COUNT MODULE_SIDE_X;// = ((17 << RESOLUTION_FACTOR) + RES_CASE(0,21,55) -100);
extern COUNT DRIVE_TOP_X;
extern COUNT DRIVE_SIDE_X;

extern void upgradethruster (void);
extern void upgrademodules (void);

extern COUNT badguysImprove;
extern COUNT NUM_DRIVE_SLOTS;
extern COUNT NUM_MODULE_SLOTS;
